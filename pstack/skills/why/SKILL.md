...
- `subagent_type`: `research` on OpenCode, or the host's configured investigator agent elsewhere
...
- `subagent_type`: `research` on OpenCode, or the host's configured synthesizer agent elsewhere
